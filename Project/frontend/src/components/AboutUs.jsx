    ...
    return(
      ...
      <div class="container">
        ...
        <div class="px-3 py-2  rounded-4 bgcolor_11">
          ...
          <p>
            Our charity wallet website is dedicated to facilitating and promoting charitable giving by providing a secure platform that connects donors and organizations. With user-friendly features,
            real-time tracking, and transparency, we aim to inspire and empower individuals to make a positive impact on the world by supporting various causes. Together, we can create a brighter 
      ...
      <div class="container my-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-12 d-flex">
            <img src="https://picsum.photos/200/200" class="d-block rounded-4 " alt="Bootstrap Themes" height="200px" width="200px" loading="lazy"/>
        ...
        <div class="row">
          ...
          <div class="col-4 my-auto">
            ...
            <div class="form-floating py-2 my-3">
              <textarea class="form-control rounded-4  my" placeholder="Name" id="floatingTextarea"></textarea>
            ...
            <div class="form-floating py-2 my-2">
                <textarea class="form-control rounded-4 h100_11" placeholder="Leave a comment here" id="floatingTextarea2" ></textarea>
                <label for="floatingTextarea2">Comments</label>
            </div>

            <div class="d-flex justify-content-center py-2 my-2">
              <button type="button" class="btn btn-lg btn-primary mx-auto">Submit</button>
            </div>
