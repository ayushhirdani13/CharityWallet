...
function Emergency(){
  ...
  useEffect(() => {
    ...
    <div class="container-fluid mt-4">
      ...
      {loading===true?( <Box sx={{height:"80%", display:"flex",justifyContent:"center",alignItems:"center"}}>
        ...
        <div class="col-xl-3 col-md-4 d-flex align-items-center my-5 rounded-4 clr mx-md-auto" >
          ...
          <div class="row d-flex justify-content-center vh-95 py-5">
            ...
            <div class="col-md-12 col-11 d-flex justify-content-center" >
              ...
              <button  onClick={()=>(window.location.href="/fundraiser/Registration")} class="btn btn-primary btn-clr text-white btn-lg  d-none d-md-block px-4 my-3 fs-3 rounded-4">Create Fundraiser </button>
            </div>
