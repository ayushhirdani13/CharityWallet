        ...
        <div class="row">
            <div class="col-8 px-0">
                ...
                <div class="py-2 my-5 rounded-4">
                    <input type="text" class="form-control border border-dark text-center" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Organizer Name"/>
                </div>
