...
const steps = ['Fundraiser Information', 'Issue And Donation Request and Address', 'Create Password','OTP'];
...
const [data,setdata]=useState();
  ...
  const handleNext = () => {
    ...
    {
      validationerrors.phoneNo="First Digit start from 6,7,8,9 if invalid contact number";
    }
...
<div className='cont1'>
    ...
    <Box className ="cont3" sx={{width:"100%",marginRight:"10px",}} >
      ...
      <Stepper activeStep={activeStep} orientation='vertical' style={{marginLeft:"10%"}}>
        ...
        activeStep === 1?(
          ...
          <Typography sx={{display:"flex",width:"100%",height:"100%",flexDirection:"column",justifyContent:"center",alignItems:"flex-start" ,gap:"20px"}}>
            ...
            <span style={{
              ...
              marginLeft:"50px"
            //   marginBottom:"10px"
              }}>Issue,Donation Request And Address</span>
